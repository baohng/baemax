...
public class PizzasAdapter extends FirebaseRecyclerAdapter<MainModel,PizzasAdapter.myViewHolder> {
     ...
     * @param options
     */
    public PizzasAdapter(@NonNull FirebaseRecyclerOptions<MainModel> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull MainModel model) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText name = view1.findViewById(R.id.txtNamePizza);
                EditText price= view1.findViewById(R.id.txtPricePizza);
                EditText describe = view1.findViewById(R.id.txtDescribePizza);
                EditText star = view1.findViewById(R.id.txtStarPizza);
                EditText surl = view1.findViewById(R.id.txtImageUrlPizza);

                Button btnUpdate = view1.findViewById(R.id.btnUpdatePizza);
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("pizzas")
