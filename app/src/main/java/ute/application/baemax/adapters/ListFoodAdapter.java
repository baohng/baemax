...
public class ListFoodAdapter extends RecyclerView.Adapter<ListFoodAdapter.CategoryViewHolder> {
    ...
    @NonNull
    @Override
    public ListFoodAdapter.CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_list,parent,false);
        return new ListFoodAdapter.CategoryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListFoodAdapter.CategoryViewHolder holder, int position) {
